...
The [Participate](/participate) page describes a weekly photography invitation that runs alongside the chalk prompt. The invitation draws on the tradition of therapeutic photography — not photography as therapy in any clinical sense, but photography as a self-initiated practice of mindful attention.
...
You are also welcome to [write a few words](/ideas) to go with your photo — a memory, an observation, a response to one of the prompts. The essay has room for both images and sentences.
